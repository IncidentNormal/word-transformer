...
import static com.duncantait.wordtransformer.integration.PathNotFound_WordTransformerApplicationIT.TEST_FILENAME;
...
class PathNotFound_WordTransformerApplicationIT {

    public static final String TEST_FILENAME = "test-path-not-found-filename.input";
    ...
    void testHappyPath(CapturedOutput output) {
        ...
        assertThat(output).contains("Cannot transform cat to pig");
    }
